...
func runDirectiveOrSubTest(t *testing.T, r *testDataReader, f func(*testing.T, *TestData) string) {
	if subTestName, ok := isSubTestStart(t, r); ok {
...
func isSubTestStart(t *testing.T, r *testDataReader) (string, bool) {
...
func isSubTestEnd(t *testing.T, r *testDataReader) bool {
	...
	return r.data.CmdArgs[0].Key == "end"
}
